package com.jianmi.news.ui.main.fragment;
...
import com.jianmi.news.ui.news.activity.PhotosDetailActivity;
import com.jianmi.news.ui.news.contract.PhotoListContract;
import com.jianmi.news.ui.news.model.PhotosListModel;
import com.jianmi.news.ui.news.presenter.PhotosListPresenter;
        ...
        adapter=new CommonRecycleViewAdapter<PhotoGirl>(getContext(),R.layout.item_photo) {
            ...
            public void convert(ViewHolderHelper helper,final PhotoGirl photoGirl) {
                ...
                Glide.with(mContext).load(photoGirl.getUrl())
                        ...
                        .placeholder(com.jianmi.common.R.drawable.ic_image_loading)
                        .error(com.jianmi.common.R.drawable.ic_empty_picture)
